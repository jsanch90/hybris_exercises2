...
public class CustombackofficeManager extends GeneratedCustombackofficeManager
{
	...
	private static final Logger LOG = Logger.getLogger(CustombackofficeManager.class.getName());
	 ...
	 */
	public static CustombackofficeManager getInstance()
	{
		return (CustombackofficeManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(CustombackofficeConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public CustombackofficeManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of CustombackofficeManager called.");
		}
	}
